...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card-body">
            <!-- ==================================== -->
            <form action="codecopy.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <!-- Inicio card-body -->
                <div class="card-body">
                    <div class="form-row">
                    ...
                    <div class="card-footer">
                        <button type="submit" name="registercopybtn" class="btn btn-primary">Guardar</button>
                        <button type="button" class="btn btn-danger" onclick="window.location.href='registercopy.php'" >Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
